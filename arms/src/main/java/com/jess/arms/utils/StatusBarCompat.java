...
public class StatusBarCompat {
    ...
    class StatusBarCompatKitKat {
         ...
         */
        private View addFakeStatusBarView(Activity activity, int statusBarColor, int statusBarHeight) {
         ...
         */
        private void addMarginTopToContentChild(View mContentChild, int statusBarHeight) {
