...
import com.bytegem.snsmax.main.di.component.DaggerCreateTopicComponent;
import com.bytegem.snsmax.main.mvp.contract.CreateTopicContract;
import com.bytegem.snsmax.main.mvp.presenter.CreateTopicPresenter;
...
public class CreateTopicActivity extends BaseActivity<CreateTopicPresenter> implements CreateTopicContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerCreateTopicComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_create_topic; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
