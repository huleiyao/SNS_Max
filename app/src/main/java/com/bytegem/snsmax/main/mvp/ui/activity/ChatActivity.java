...
import com.bytegem.snsmax.main.di.component.DaggerChatComponent;
import com.bytegem.snsmax.main.mvp.contract.ChatContract;
import com.bytegem.snsmax.main.mvp.presenter.ChatPresenter;
...
public class ChatActivity extends BaseActivity<ChatPresenter> implements ChatContract.View {
    ...
    @OnClick({R.id.cream, R.id.select_pic, R.id.emoje, R.id.voice})
    void onClick() {
