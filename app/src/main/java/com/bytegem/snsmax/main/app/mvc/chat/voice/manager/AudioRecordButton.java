package com.bytegem.snsmax.main.app.mvc.chat.voice.manager;
...
import com.bytegem.snsmax.main.app.mvc.chat.voice.utils.FileUtils;

/**
 * https://github.com/HandsomeBoy11
 */
...
public class AudioRecordButton extends AppCompatTextView
    ...
    boolean isShcok;
    //是否长按触发录制
    private boolean isLongClickRecording = true;
    ...
    /**
     * 是否长按触发录音。默认：是
     * @param longClickRecording
     */
    public void setLongClickRecording(boolean longClickRecording) {
        isLongClickRecording = longClickRecording;
    }
