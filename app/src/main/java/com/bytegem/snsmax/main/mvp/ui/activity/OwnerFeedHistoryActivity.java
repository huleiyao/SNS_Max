...
import com.bytegem.snsmax.main.di.component.DaggerOwnerFeedHistoryComponent;
import com.bytegem.snsmax.main.mvp.contract.OwnerFeedHistoryContract;
import com.bytegem.snsmax.main.mvp.presenter.OwnerFeedHistoryPresenter;
...
public class OwnerFeedHistoryActivity extends BaseActivity<OwnerFeedHistoryPresenter> implements OwnerFeedHistoryContract.View {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_owner_feed_history; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
