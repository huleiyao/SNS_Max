 ...
 * ================================================
 */
public interface FeedCommentsOfCommentContract {
    ...
    interface Model extends IModel {
        Observable<LISTFeedComments> getList(int feedId, int id, int limit, int commentId, boolean isDefaultOrder, boolean isFirst);
