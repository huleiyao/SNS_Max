 ...
 */
@ActivityScope
public class CommunityPostCommentsOfCommentModel extends BaseModel implements CommunityPostCommentsOfCommentContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public CommunityPostCommentsOfCommentModel(IRepositoryManager repositoryManager) {
        super(repositoryManager);
    }

    @Override
    public Observable<CommunityCommentsList> getList(int feedId, int id, int limit, int commentId, boolean isDefaultOrder, boolean isFirst) {
        if (isFirst)
