...
public class OwnerGroupsAdapter extends BaseQuickAdapter<MBaseBean, BaseViewHolder> {

    public OwnerGroupsAdapter() {
        super(R.layout.item_owner_group);
    }
...
//        viewHolder.setText(R.id.area_name, bean);
        ...
        ,viewHolder.getView(R.id.owner_group_cover));
    }
