...
import com.bytegem.snsmax.main.di.component.DaggerOwnerGroupsComponent;
import com.bytegem.snsmax.main.mvp.contract.OwnerGroupsContract;
import com.bytegem.snsmax.main.mvp.presenter.OwnerGroupsPresenter;
 ...
 * ================================================
 */
public class OwnerGroupsFragment extends BaseFragment<OwnerGroupsPresenter> implements OwnerGroupsContract.View {
    ...
    private static OwnerGroupsFragment instance;
    private boolean isMe;
    CreatGroupHeaderView header;

    public static OwnerGroupsFragment newInstance(boolean isMe) {
        if (instance == null)
            instance = new OwnerGroupsFragment();
        instance.setMe(isMe);
        return instance;
    }
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerOwnerGroupsComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_owner_groups, container, false);
    }
