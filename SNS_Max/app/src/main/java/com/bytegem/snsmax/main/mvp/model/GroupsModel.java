 ...
 */
@FragmentScope
public class GroupsModel extends BaseModel implements GroupsContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GroupsModel(IRepositoryManager repositoryManager) {
        super(repositoryManager);
    }


    @Override
    public Observable<LISTGroup> getGroupList() {
        return mRepositoryManager
                .obtainRetrofitService(GroupService.class)
                .getGroupList(MApplication.getTokenOrType());
    }
